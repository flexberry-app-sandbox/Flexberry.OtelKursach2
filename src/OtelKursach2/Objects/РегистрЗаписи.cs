...
namespace IIS.OtelKursach2
{
    ...
    public class РегистрЗаписи : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РегистрЗаписиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РегистрЗаписиE", typeof(IIS.OtelKursach2.РегистрЗаписи));
                }
            }
        }
    }
    ...
    public class DetailArrayOfРегистрЗаписи : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.OtelKursach2.DetailArrayOfРегистрЗаписи members)

        // *** End programmer edit section *** (IIS.OtelKursach2.DetailArrayOfРегистрЗаписи members)
        ...
        /// </summary>
        public DetailArrayOfРегистрЗаписи(IIS.OtelKursach2.Доступ fДоступ) : 
                base(typeof(РегистрЗаписи), ((ICSSoft.STORMNET.DataObject)(fДоступ)))
        {
        }
        
        public IIS.OtelKursach2.РегистрЗаписи this[int index]
        {
            get
            {
                return ((IIS.OtelKursach2.РегистрЗаписи)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.OtelKursach2.РегистрЗаписи dataobject)
        {
